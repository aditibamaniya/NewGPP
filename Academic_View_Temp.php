...
if(isset($_POST['submit']))
{
	...
	$table_name = "Location:Display_" . $selected_val1 . "_" . $selected_val2 . "_" . $selected_val3 ."_student_academic_info_Temp.php";
	header($table_name);
}
?>
<html>
...
<br/>
<br/>
<h3 align="center"><b> Student Academic Information...</b></h3>
