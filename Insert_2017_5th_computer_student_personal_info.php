...
include("Header_Admin.php");
	...
	if(isset($_POST['check']))
	{
		...
		$Query = "Select * from 2017_5th_computer_student_personal_info where enr_no='$enr_no'";
	...
	if(isset($_POST['Insert']))
	{
		...
		$Query = "INSERT INTO `2017_5th_computer_student_personal_info` (`enr_no`, `name`, `address`, `birth_date`, `email`,`category`, `mobile(self)`, `mobile(home)`, `district`, `gender`) VALUES ('$enr_no', '$name', '$address', '$birth_date', '$email', '$category', '$tel', '$tel1', '$district', '$gender' );";
