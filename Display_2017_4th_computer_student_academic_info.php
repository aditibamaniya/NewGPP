...
include("Header_Admin.php");
	...
	if(@$_GET['enr_no']!="")
	{
		$Query = "Delete From 2017_4th_computer_student_academic_info where enr_no=".$_GET['enr_no'];
...
?>
	<tr>
		...
		<td>
			<a href="upd_2017_4th_computer_student_academic_info.php ?enr_no=<?php echo $data[0]?>">Update</a>
		</td>
	</tr>
