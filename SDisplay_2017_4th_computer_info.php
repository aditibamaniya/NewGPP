...
include("Header_Clerk.php");
	...
	if(@$_GET['enr_no']!="")
	{
		$Query = "Delete From 2017_4th_computer_student_info where enr_no=".$_GET['enr_no'];
	...
	{
		$Query = "Select * from 2017_4th_computer_student_info where enr_no='".$_POST['valueToSearch']."' " or die("Database Error : ".mysql_error());
	
		$res = mysql_query($Query) or die("<h2>$Query</h2> Query Error :".mysql_error());
	}
	else
	{
		$Query = "Select * from 2017_4th_computer_student_info"  or die("Database Error : ".mysql_error());
...
<h3 align="center"><b> 2017 Computer Semester 4 Student Fees Status...</b></h3>
...
?>
	<tr>
		...
		<td>
			<a href="upd_Student_2017_4th_computer.php ?enr_no=<?php echo $data[0]?>">Update</a>
		</td>
	</tr>
