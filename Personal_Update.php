...
if(isset($_POST['submit']))
{
	...
	$table_name = "Location:Display_" . $selected_val1 . "_" . $selected_val2 . "_" . $selected_val3 ."_student_personal_info.php";
	header($table_name);
}
?>
<html>
...
<h3 align="center"><b> Update Student Personal Information...</b></h3>
<br/>
<br/>
