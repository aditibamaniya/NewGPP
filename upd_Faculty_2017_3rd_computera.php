...
include("Header_Admin.php");
	...
	$Query = "Select * from 2017_3rd_computer_faculty_info where comp_faculty_id=".$_GET['comp_faculty_id'];
	...
	if(isset($_POST['Update']))
	{
		...
		$Query = "UPDATE `2017_3rd_computer_faculty_info` SET `comp_faculty_id`='$comp_faculty_id', `subject`='$subject',`semester_incharge`='$semester_incharge' where `2017_3rd_computer_faculty_info`.`comp_faculty_id` = $comp_faculty_id;";
		
		mysql_query($Query) or die("<h2>$Query</h2> Query Error :".mysql_error());
		
		header("Location:FDisplay_2017_3rd_computer_infoa.php");
	}
?>
<div class="container">
