...
include("Header_Clerk.php");
	...
	if(isset($_POST['check']))
	{
		...
		$Query = "Select * from 2017_1st_computer_student_info where enr_no='$enr_no'";
	...
	if(isset($_POST['Insert']))
	{
		...
		$Query = "INSERT INTO `2017_1st_computer_student_info`(`enr_no`,`library_fees`,`mid_sem_fees`,`external_exam_fees`) VALUES ('$enr_no','$library_fees','$mid_sem_fees','$external_exam_fees');";
