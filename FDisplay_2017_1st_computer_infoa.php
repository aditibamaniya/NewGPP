...
include("Header_Admin.php");
	...
	{
		$Query = "Delete From 2017_1st_computer_faculty_info where comp_faculty_id=".$_GET['comp_faculty_id'];
		
		mysql_query($Query) or die("<h2>$Query</h2> Query Error : ".mysql_error());
		
		echo "Record  Deleted..";
	}
	$Query = "Select * from 2017_1st_computer_faculty_info" or die("Query Error : ".mysql_error());
...
?>
	<tr>
		...
		<td>
			<a href="upd_Faculty_2017_1st_computera.php ?comp_faculty_id=<?php echo $data[0]?>">Update</a>
		</td>
	</tr>
