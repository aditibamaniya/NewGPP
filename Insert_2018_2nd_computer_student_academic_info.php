...
include("Header_Admin.php");
	...
	if(isset($_POST['check']))
	{
		...
		$Query = "Select * from 2018_2nd_computer_student_academic_info where enr_no='$enr_no'";
	...
	if(isset($_POST['Insert']))
	{
		...
		$Query = "INSERT INTO `2018_2nd_computer_student_academic_info` (`enr_no`, `name`, `stream`, `current_sem`, `current_year`,`ssc`, `hsc`,`cpi`,`spi`) VALUES ('$enr_no', '$name', '$stream', '$current_sem', '$current_year','$ssc', '$hsc' , '$cpi', '$spi');";
