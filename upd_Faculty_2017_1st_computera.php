...
include("Header_Admin.php");
	...
	$Query = "Select * from 2017_1st_computer_faculty_info where comp_faculty_id=".$_GET['comp_faculty_id'];
	...
	if(isset($_POST['Update']))
	{
		...
		$Query = "UPDATE `2017_1st_computer_faculty_info` SET `comp_faculty_id`='$comp_faculty_id', `subject`='$subject',`semester_incharge`='$semester_incharge' where `2017_1st_computer_faculty_info`.`comp_faculty_id` = $comp_faculty_id;";
		
		mysql_query($Query) or die("<h2>$Query</h2> Query Error :".mysql_error());
		
		header("Location:FDisplay_2017_1st_computer_infoa.php");
	}
?>
<div class="container">
	 <form class="form-horizontal" action="" method="POST" onsubmit="return confirm('Do You Really Want To Update YOur Record?')">
		  <div class="form-group">
		   ...
		   <div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" class="form-control" pattern="[A-Za-z]{3}" name="subject" placeholder="subject"  value="<?php echo $data[1]?>">
			</div>
		  </div>
		   <div class="form-group">
